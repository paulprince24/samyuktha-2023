    ...
    <>
      ...
      <center className="mt-5">
        <form className="contact_form rounded-7 m-3 p-3">
          <center>
            <h2 className="about_head text-warning">Contact Us</h2>
          </center>
          <div class="form-outline mb-4">
            ...
            />
            <label class="form-label text-light" for="form4Example1">
              Name
            </label>
          </div>
          ...
          <div class="form-outline mb-4">
            <input
              type="email"
              id="form4Example2"
              class="form-control form-control border-bottom border-white"
            />
            <label class="form-label text-light" for="form4Example2">
              Email address
            </label>
          </div>
          ...
          <div class="form-outline mb-4">
            <textarea
              class="form-control form-control border-bottom"
              id="form4Example3"
              rows="4"
            ></textarea>
            <label class="form-label text-light" for="form4Example3">
              Message
            </label>
          </div>
